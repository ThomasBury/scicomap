...
def _get_color_weak_cmap(color_map, n_images):
    ...
    sub_title = (
        ["Normal (~95% of pop)"]
        + n_blank * [""]
        + ["Deuter-50% (RG-weak, D/P: 5% of male)"]
        + n_blank * [""]
        + ["Prot-50% (RG-weak, D/P: 5% of male)"]
        + n_blank * [""]
        + ["Deuter-100% (RG-blind, D/P: g5% of male)"]
        + n_blank * [""]
        + ["Trit-100% (BY deficient, very rare)"]
        + n_blank * [""]
    )
...
def _get_color_weak_ctab(color_map, n_blank):
    ...
    sub_title = (
        ...
        + ["Prot-50% (RG-weak, D/P: 5% of male)"]
        + n_blank * [""]
        + ["Deuter-100% (RG-blind, D/P: 5% of male)"]
        + n_blank * [""]
        + ["Trit-100% (BY deficient, very rare)"]
        + n_blank * [""]
    )
